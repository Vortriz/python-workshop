...
#slide[
  ...
  #table(
    ...
    table.header([Feature], [`requirements.txt`], [`environment.yml`], [`pyproject.toml`], [`pyproject.toml` + Lockfile]),
    [Scope], [Direct dependencies only], [Environment specification], [Project metadata (PEP 621)], [Full project snapshot],
    [Transitive Locking], [No], [Requires external tool], [No], [Yes (Native)],
    [Deterministic], [No], [Requires external tool], [No], [Yes],
    [Reproducibility], [Low], [Medium (Platform-bound)], [Low], [High (Universal)],
  )
]
...
#slide[
  ...
  #table(
    ...
    [Dependencies], [External environment management.], [Can do inline sandboxing (package requirements serialized in the file).],
    [Reusability], [Not possible to import or run as a standalone script.], [Can be imported as a module or executed from CLI.],
